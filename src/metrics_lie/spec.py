...
class DatasetSpec(BaseModel):
    ...
    y_true_col: str = Field(..., description="Column name for ground-truth labels (0/1).")
    y_score_col: str = Field(..., description="Column name for predicted probabilities (0..1).")
...
class ExperimentSpec(BaseModel):
    ...
    tags: Dict[str, str] = Field(default_factory=dict, description="Optional metadata tags.")
